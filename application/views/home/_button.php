		<div class="text-center">
            <a href="<?php echo base_url() . 'home/dotryout' ?>" type="submit" class="btn btn-primary btn-lg btnku"><i class="glyphicon glyphicon-pencil bigger" ></i> <h3>Mulai try out</h3></a> 
