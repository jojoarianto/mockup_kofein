            ...
            <form method="POST" action="http://artodo.co.id/auth/register" accept-charset="UTF-8"><input name="_token" type="hidden" value="ZmIlF9j9LMTzUAZ1TUFlLuHaJURR4kmWTYnlRsHa">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Email anda" required="required" name="email" type="email" value="">
                </div>
                <div class="form-group">
                  <label for="password">Password</label>
                  <input class="form-control" placeholder="Password anda" required="required" name="email" type="email" value="">
                </div>
                <div class="form-group">
                  <label for="email">Confirm Password</label>
                  <input class="form-control" placeholder="Ulangi password anda" required="required" name="email" type="email" value="">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Nomor telepon anda" required="required" autofocus="autofocus" name="name" type="text" value="">
                </div>
